#+TITLE: Inventaire des orgues - ressources humaines
...
assurer le bon fonctionnement de la plate-forme et l’animation du
réseau des contributeurs.
 
* Animateur / gestionnaire de bases de données

** Compétences d'animateur de communautés en ligne

 - Familiarité avec l'échange via un [[https://forum.inventaire-des-orgues.fr/][forum]].

 - Familiarité avec des outils de gestion de listes de diffusion,
   notamment [[https://www.mailchimp.com][mailchimp.com]], actuellement utilisé pour collecter les
   adresses électroniques des personnes souhaitant être tenues
   informées du projet.

 - Familiarité avec les outils de réseaux sociaux, notamment Twitter,
   pour la gestion du compte [[https://twitter.com/soulierdorgue][@soulierdorgue]].
...
*** Rôle dans l’animation communautaire
 ...
 L’animateur assure aussi le lien entre les contributeurs réguliers et
...
*** Rôle dans l'importation des données 
 ...
 Cet export sera soit un export complet des bases, soit un export
 limité aux données concernant les orgues, buffets d'orgue et édifices
...
*** Rôle dans l’établissement des statistiques
 ...
 L'animateur a accès à l'outil de suivi des statistiques de
...
- Connaissances en devops : savoir gérer une installation [[http://docker.io/][docker]] et
  utiliser [[https://docs.docker.com/compose/][docker-compose]].

- Connaissances en développement : Git, Java, Clojure.  Savoir au
  moins lancer un =java -jar= et configurer le système pour le relancer
  si besoin.

- Familiarité avec des services web comme [[https://www.gandi.net/fr][gandi.net]], [[https://www.digitalocean.com/][digitalocean.com]],
  [[https://www.mailgun.com/][mailgun.com]], [[https://mailchimp.com/][mailchimp.com]], [[https://www.filestack.com/][filestack.com]], [[https://www.statuscake.com/][statuscake.com]].

- Autre : [[https://jekyllrb.com/][jekyll]], [[https://fr.wikipedia.org/wiki/Markdown][markdown]] et d’[[http://orgmode.org/][Emacs org-mode]] non indispensables mais
  utiles.
